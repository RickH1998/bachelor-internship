...
BaseDirectory = '/media/rick/Data/Bachelor_stage_Moritz/2019_05_29_ClearmapColumn/66632_arivis_A1/';
...
# TODO Maren: 
cFosFile = os.path.join('/media/rick/Data/Bachelor_stage_Moritz/Isolation_brain_regions/Brains/Brains/66632/Source/14-58-22_66632_TdTom_UltraII_C00_xyz-Table Z\d{4}.ome.tif');
AutofluoFile = cFosFile;

#convert csv to npy
cellspoints = numpy.loadtxt(os.path.join(BaseDirectory,'66632_X_Y_Z_Coordinates_A1.csv'), delimiter = ",")
...
PathReg        = '/media/rick/Data/Bachelor_stage_Moritz/Isolation_brain_regions/atlas/';
